...
| [`apple-fluidity-lab`](./apple-fluidity-lab/) | WWDC fluid interface study with 1:1 direct manipulation, momentum projection, analytical springs, boundary rubber-banding, and mid-flight interruption | Initial working slice |
...
| [`vessel-visual-lab`](./vessel-visual-lab/) | Provisional local single-asset image/PDF preflight utility with responsive website and interactive macOS workbench studies | Working lab |
