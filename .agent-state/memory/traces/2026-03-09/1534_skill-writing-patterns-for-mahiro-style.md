...
- `.agent-state/memory/retrospectives/2026-03/03/15.25_skill-ecosystem-deep-dive.md` - previous multi-repo skill comparison work
- `.agent-state/memory/learnings/2026-03-03_skill-repository-archetypes.md` - build-tool vs production-capability vs knowledge-base archetypes
- `.agent-state/memory/learnings/2026-03-08_mahiro-style-needs-real-refactor-feedback-loops.md` - doctrine should grow from real refactors
- `.agent-state/memory/learnings/2026-03-09_mahiro-style-doctrine-refinement-through-console-layout-review.md` - recent concrete refinement rules for ownership and i18n posture
...
- `.agent-state/memory/learnings/2026-02-26_frontend-skill-structure-resources-examples.md` - layered skill contract: `SKILL.md`, `scripts/`, `resources/`, `examples/`
- `.agent-state/memory/learnings/2026-03-03_skill-repository-archetypes.md` - external repo comparison lens
- `.agent-state/memory/learnings/2026-03-08_mahiro-style-needs-real-refactor-feedback-loops.md` - `mahiro-style` should be shaped by live refactor pressure
- `.agent-state/memory/learnings/2026-03-09_mahiro-style-doctrine-refinement-through-console-layout-review.md` - owner-local data, naming, and `t` vs `msg` refinements
- `.agent-state/inbox/handoff/2026-03-08_16-49_console-refactor-and-mahiro-style-follow-up.md` - explicit next step to sharpen `mahiro-style` from real review findings

### Learned external repo docs

- `.agent-state/learn/vercel-labs/agent-skills/repo.md`
- `.agent-state/learn/vercel-labs/agent-skills/2026-03-09/1508_ARCHITECTURE.md`
- `.agent-state/learn/vercel-labs/agent-skills/2026-03-09/1508_API-SURFACE.md`
- `.agent-state/learn/vercel-labs/agent-skills/2026-03-09/1508_TESTING.md`
- `.agent-state/learn/anthropics/skills/repo.md`
- `.agent-state/learn/anthropics/skills/2026-03-09/1511_QUICK-REFERENCE.md`
- `.agent-state/learn/anthropics/skills/2026-03-09/1511_API-SURFACE.md`
- `.agent-state/learn/anthropics/skills/origin/skills/skill-creator/SKILL.md`
- `.agent-state/learn/anthropics/skills/origin/template/SKILL.md`
- `.agent-state/learn/anthropics/skills/origin/.claude-plugin/marketplace.json`
