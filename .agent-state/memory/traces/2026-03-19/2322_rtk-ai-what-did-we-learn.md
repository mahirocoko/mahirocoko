...
- `.agent-state/memory/learnings/2026-03-07_when-porting-a-command-rewrite-pattern-from-one-ai.md`
- `.agent-state/memory/learnings/2026-03-09_when-using-rtk-in-shell-workflows-the-stable-rule.md`
- `.agent-state/memory/learnings/2026-03-10_if-a-team-wants-a-stricter-local-rtk-rule-than-ups.md`

## Files Found

- `.agent-state/learn/rtk-ai/rtk/rtk.md`
- `.agent-state/learn/rtk-ai/rtk/2026-03-07/2129_ARCHITECTURE.md`
- `.agent-state/learn/rtk-ai/rtk/2026-03-07/2129_CODE-SNIPPETS.md`
- `.agent-state/learn/rtk-ai/rtk/2026-03-07/2129_QUICK-REFERENCE.md`
- `.agent-state/learn/rtk-ai/rtk/2026-03-07/2129_TESTING.md`
- `.agent-state/learn/rtk-ai/rtk/2026-03-07/2129_API-SURFACE.md`
- `.agent-state/memory/retrospectives/2026-03/07/22.05_cursor-rtk-hook-and-cli-fit.md`
- `.agent-state/memory/retrospectives/2026-03/09/16.38_rtk-command-shape-in-claude-guidance.md`
...
- `.agent-state/learn/.origins` lists `rtk-ai/rtk`
