...
- `.agent-state/memory/retrospectives/2026-03/02/13.37_hrm-ring-token-and-styleguide-consistency.md` - explicit styleguide/component token consistency work.
- `.agent-state/memory/retrospectives/2026-03/02/13.05_hrm-state-token-iteration-and-variant-alignment.md` - component state/variant iteration with styleguide checks.
- `.agent-state/memory/retrospectives/2026-02/28/14.06_hrm-login-02-field-pattern-and-trans-copy.md` - direct field/label pattern migration notes.
- `.agent-state/memory/retrospectives/2026-02/28/13.19_hrm-checkbox-base-ui-alignment.md` - Base UI checkbox variant analysis.
- `.agent-state/memory/retrospectives/2026-02/25/10.50_button-component-system-radius-alignment.md` - component system tuning history.
- `.agent-state/memory/learnings/2026-02-28_base-ui-vs-radix-checkbox-variant.md` - distilled finding on primitive stack alignment.
- `.agent-state/memory/learnings/2026-03-02_token-doc-lockstep-prevents-design-system-drift.md` - token+doc synchronization pattern for components.
- `.agent-state/incubate/haabiz/haabiz-hrm-fe/app/routes/styleguide.tsx` - live component showcase surface used during analysis.
- `.agent-state/incubate/haabiz/haabiz-hrm-fe/app/components/ui/field.tsx` - Field primitive contract reference.
- `.agent-state/incubate/haabiz/haabiz-hrm-fe/app/components/ui/label.tsx` - Label primitive contract reference.
...
- `.agent-state/memory/retrospectives/2026-03/02/15.51_shadow-tokens-and-checkbox-scale.md` - scale contract decisions recorded.
- `.agent-state/memory/retrospectives/2026-02/27/22.04_frontend-skill-token-first-presets-and-hrm-commit.md` - frontend-skill and HRM component alignment context.
- `.agent-state/memory/learnings/2026-02-26_frontend-skill-structure-resources-examples.md` - examples-first resource structure.
