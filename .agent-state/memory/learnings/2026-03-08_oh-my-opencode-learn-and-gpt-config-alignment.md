...
- Turning the agent-role explanation into `.agent-state/learn/code-yeongyu/oh-my-openagent/AGENT-CHEATSHEET.th.md` made the research immediately reusable for future sessions.

## Reusable Method

1. Register the studied repo under `.agent-state/learn/.origins` and link `origin/`.
