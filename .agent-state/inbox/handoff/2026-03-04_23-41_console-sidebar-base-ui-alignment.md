...
## Key Files
- `.agent-state/incubate/haabiz/haabiz-hrm-fe/app/routes/console.tsx`
- `.agent-state/incubate/haabiz/haabiz-hrm-fe/app/components/layouts/console/app-sidebar.tsx`
- `.agent-state/incubate/haabiz/haabiz-hrm-fe/app/components/layouts/console/nav-main.tsx`
- `.agent-state/incubate/haabiz/haabiz-hrm-fe/app/components/layouts/console/nav-user.tsx`
- `.agent-state/incubate/haabiz/haabiz-hrm-fe/app/components/layouts/console/team-switcher.tsx`
- `.agent-state/incubate/haabiz/haabiz-hrm-fe/app/components/ui/sidebar.tsx`
- `.agent-state/incubate/haabiz/haabiz-hrm-fe/app/components/ui/breadcrumb.tsx`
- `.agent-state/incubate/haabiz/haabiz-hrm-fe/app/components/ui/collapsible.tsx`
- `.agent-state/incubate/haabiz/haabiz-hrm-fe/app/components/ui/sheet.tsx`
- `.agent-state/incubate/haabiz/haabiz-hrm-fe/app/components/ui/tooltip.tsx`
- `.agent-state/incubate/haabiz/haabiz-hrm-fe/app/routes/styleguide.tsx`
- `.agent-state/incubate/haabiz/haabiz-hrm-fe/test/console-routes.test.tsx`
