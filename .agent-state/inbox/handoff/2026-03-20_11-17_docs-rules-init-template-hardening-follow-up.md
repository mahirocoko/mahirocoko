...
- `.agent-state/memory/retrospectives/2026-03/20/11.14_docs-rules-init-template-hardening.md`
- `.agent-state/memory/learnings/2026-03-20_docs-rules-init-templates-need-real-output-review.md`
