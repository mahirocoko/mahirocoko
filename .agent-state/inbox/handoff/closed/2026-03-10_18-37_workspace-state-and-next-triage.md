...
- [ ] Review `.agent-state/memory/learnings/2026-03-10_local-rtk-policy-needs-hook-and-integrity-alignment.md` and `.agent-state/memory/retrospectives/2026-03/10/` to decide whether they are ready to commit.
...
- `.agent-state/memory/learnings/2026-03-10_local-rtk-policy-needs-hook-and-integrity-alignment.md`
- `.agent-state/memory/retrospectives/2026-03/10/`
